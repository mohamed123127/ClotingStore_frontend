    ...
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        ...
        <div className="text-center px-4 py-7.5">
          ...
          <h3 className="text-heading-6 font-medium text-dark ease-out duration-200 hover:text-blue mb-1.5">
            <Link href="/shop-details"> {item.name} </Link>
          </h3>

          <span className="flex justify-center items-center gap-2 font-medium text-lg">
