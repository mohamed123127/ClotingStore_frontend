      ...
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        <div className="relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15">
          ...
          {/* <Image
            ...
            alt="bg shapes"
            className="hidden sm:block absolute ltr:right-0 rtl:left-0 rtl:rotate-180 bottom-0 -z-1"
            width={737}
            height={482}
          /> */}
          <Image
            src="/images/hero/StoreOpenOffer.png"
            alt="product"
            className="hidden lg:block absolute ltr:right-4 ltr:xl:right-33 rtl:left-4 rtl:xl:left-33 bottom-4 xl:bottom-10 -z-1"
            width={411}
            height={376}
          />
        </div>
